...
export type GetMyTimeBlocksQuery = { __typename?: 'Query', myTimeBlocks: Array<{ __typename?: 'TimeBlock', id: string, daysOfWeek: Array<number>, startTime: string, endTime: string, createdAt: any, activityType?: { __typename?: 'ActivityType', id: string, name: string, color: string } | null }> };
