...
export type GetMyTodosForOnboardingQuery = { myTodos: Array<{ id: string, title: string, priority: number, activityType: { id: string, name: string, color: string } | null }> };
...
export type GetProfileForSettingsQuery = { myProfile: { id: string } | null };
