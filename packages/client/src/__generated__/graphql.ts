...
export type GetProfileForSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProfileForSettingsQuery = { myProfile: { id: string, icalSecret: string } | null };

export type RegenerateIcalSecretMutationVariables = Exact<{ [key: string]: never; }>;


export type RegenerateIcalSecretMutation = { myRegenerateIcalSecret: string };
...
export const GetProfileForSettingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetProfileForSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myProfile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"icalSecret"}}]}}]}}]} as unknown as DocumentNode<GetProfileForSettingsQuery, GetProfileForSettingsQueryVariables>;
export const RegenerateIcalSecretDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RegenerateIcalSecret"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myRegenerateIcalSecret"}}]}}]} as unknown as DocumentNode<RegenerateIcalSecretMutation, RegenerateIcalSecretMutationVariables>;
