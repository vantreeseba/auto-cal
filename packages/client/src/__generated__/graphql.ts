...
export type TimeBlock_TimeBlockListFragment = { __typename?: 'TimeBlock', id: string, daysOfWeek: Array<number>, startTime: string, endTime: string, createdAt: any, activityType?: { __typename?: 'ActivityType', id: string, name: string, color: string } | null };
...
export type GetMyHabitsForDetailQuery = { __typename?: 'Query', habit?: { __typename?: 'Habit', id: string, title: string, description?: string | null, priority: number, estimatedLength: number, frequencyCount: number, frequencyUnit: string, createdAt: any, activityType?: { __typename?: 'ActivityType', id: string, name: string, color: string } | null } | null };
...
export type GetMyTimeBlocksV2QueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyTimeBlocksV2Query = { __typename?: 'Query', myTimeBlocks: Array<{ __typename?: 'TimeBlock', id: string, daysOfWeek: Array<number>, startTime: string, endTime: string, createdAt: any, activityType?: { __typename?: 'ActivityType', id: string, name: string, color: string } | null }> };

export type GetMyTodosV2QueryVariables = Exact<{ [key: string]: never; }>;


export type GetMyTodosV2Query = { __typename?: 'Query', myTodos: Array<{ __typename?: 'Todo', id: string, title: string, description?: string | null, priority: number, estimatedLength: number, scheduledAt?: any | null, completedAt?: any | null, createdAt: any, activityType?: { __typename?: 'ActivityType', id: string, name: string, color: string } | null }> };
...
export const GetMyTodosV2Document = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMyTodosV2"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myTodos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"Todo_TodoList"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Todo_TodoList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Todo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"priority"}},{"kind":"Field","name":{"kind":"Name","value":"estimatedLength"}},{"kind":"Field","name":{"kind":"Name","value":"activityType"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<GetMyTodosV2Query, GetMyTodosV2QueryVariables>;